...
"");a=JSON.stringify(a)+"\n";this.clog(a);this.last_ping=this.getUnixTime();wx.sendSocketMessage({data:a});return!0};this.set_state=function(a,b){this.from_state=this.conn_state;this.conn_state=a;this.ADVANCED_DEBUG&&this.clog("set_state: "+this.from_state+" \x3d\x3e "+this.conn_state);b&&this.state_changed_handler()};this.onConnectionOpen=function(a){this.clog("onConnectionOpen:");this.network_retry_failure_counter_reset();"SERVERINFO_REQ"==this.target_state?this.req_server_info():"INITIAL_LOGIN"==
this.target_state?this.login_(!0):"SESSION_LOGIN"==this.target_state?this.login_(!1):"REGISTRATION"==this.target_state?this.send_registration():"GUEST_SEND"==this.target_state&&(this.conn_state="LOGIN_SCREEN_ENABLED",this.send_all_after_connect())};this.onConnectionClose=function(){this.clog("onConnectionClose:");this.reset_websocket_conn();this.revert_and_reset_state();setTimeout(e(this.connect,this),1E3*this.network_retry_timer_value())};this.onConnectionMessage=function(a){this.last_resp=this.getUnixTime();
a=a.data.replace(/[\s\r\n]+$/,"").split("\n");a.splice(0,1);this.clog(this.pretty("["+a.join(",")+"]"));a=JSON.parse("["+a.join(",")+"]");for(var b=0,d=a.length;b<d;b++){var c=a[b];this.not_empty(c,"sess")&&(this.sess=c.sess);this.not_empty(c,"sessreset")&&c.sessreset==this.sess&&"IN_SESSION"==this.conn_state&&this.login_(!1);if("server"!=c.obj||"ping"!=c.act&&"pinw"!=c.act){"server"==c.obj&&"info"==c.act&&(this.server_info=c.server_info,"SERVERINFO_REQ"==this.conn_state&&c.server_info&&this.set_state("LOGIN_SCREEN_ENABLED",
!0));if("person"==c.obj&&"login"==c.act||"person"==c.obj&&"register"==c.act)c.user_info&&(this.user_info=c.user_info),c.server_info&&(this.server_info=c.server_info),""!=this.sess?("REGISTRATION"==this.conn_state&&(this.login_name=this.registration.login_name,this.login_passwd=this.registration.login_passwd,this.credential_data=this.registration.credential_data,this.registration=null),"INITIAL_LOGIN"==this.conn_state||"REGISTRATION"==this.conn_state?this.set_state("IN_SESSION",!0):this.set_state("IN_SESSION",
!1),this.send_all_after_login()):(this.registration=this.user_info=null,this.login_passwd=this.login_name="",this.credential_data=null,"REGISTRATION"==this.conn_state?this.set_state("LOGIN_SCREEN_ENABLED",!1):this.set_state("LOGIN_SCREEN_ENABLED",!0));"person"==c.obj&&"logout"==c.act&&(this.user_info=null,this.login_passwd=this.login_name=this.sess="",this.credential_data=null,this.reset_websocket_conn(),this.set_state("LOGIN_SCREEN_ENABLED",!0));"sdk"==c.obj&&"logreq"==c.act&&this.sdk_logsend(c.from_pid);
"sdk"==c.obj&&"user_data"==c.act&&(null==c.data?this.sdk_userdatasend(c.from_pid):this.user_data=c.data);"sdk"==c.obj&&"user_joread"==c.act&&this.sdk_joreadsend(c.from_pid,this.user_joread());"sdk"==c.obj&&"user_jowrite"==c.act&&this.user_jowrite(c.data);this.response=c;this.response_received_handler(c)}}};this.onConnectionError=function(){this.clog("onConnectionError:");this.reset_websocket_conn();this.revert_and_reset_state();setTimeout(e(this.connect,this),1E3*this.network_retry_timer_value())};
this.connect=function(){null==this.response_received_handler?this.clog("connect: response_received_handler is missing, connect ignored"):null==this.state_changed_handler?this.clog("connect: state_changed_handler is missing, connect ignored"):"CONNECTING"==this.conn_state?this.clog("connect: already connecting, connect request is ignored"):("LOGIN_SCREEN_ENABLED"==this.conn_state&&null!=this.registration&&(this.target_state="REGISTRATION",this.reset_websocket_conn()),"INITIAL_LOGIN"!=this.target_state||
null!=this.login_name&&""!=this.login_name||null!=this.credential_data?(this.last_connecting=this.getUnixTime(),this.set_state("CONNECTING",!1),this.clog("websocket create: wsUri:"+this.wsUri+" from_state:"+this.from_state+" state:"+this.conn_state),wx.onSocketOpen(e(this.onConnectionOpen,this)),wx.onSocketClose(e(this.onConnectionClose,this)),wx.onSocketError(e(this.onConnectionError,this)),wx.onSocketMessage(e(this.onConnectionMessage,this)),this.websocket=wx.connectSocket({url:this.wsUri})):this.logout_())};
this.login=function(a,b){this.credential(a,b);this.login_(!0)};this.loginx=function(a){this.credentialx(a);this.login_(!0)};this.logout=function(){this.credential("","");this.connect()};this.register=function(a){this.registration=a;this.send_registration()};this.login_=function(a){if(null!=this.credential_data||""!=this.login_name)if(null!=this.credential_data||""!=this.login_passwd){var b={obj:"person",act:"login"};a&&(b.sdk_version_webapp=this.version());null==this.credential_data?(b.login_name=
this.login_name,b.login_passwd=this.login_passwd):b.credential_data=this.credential_data;a&&(b.verbose=1);if(null==this.user_info||0==Object.keys(this.user_info).length)b.verbose=1;a?this.set_state("INITIAL_LOGIN",!0):this.set_state("SESSION_LOGIN",!1);this.send_obj_now(b)}};this.logout_=function(){""!=this.sess&&(this.set_state("LOGIN_SCREEN_ENABLED"),this.send_obj_now({obj:"person",act:"logout"}))};this.send_registration=function(){null!=this.registration&&(this.login_passwd=this.login_name=this.sess=
"",this.credential_data=null,this.registration.obj="person",this.registration.act="register",this.set_state("REGISTRATION",!0),this.send_obj_now(this.registration))};this.ping=function(){this.send_obj_now({obj:"server",act:"pinw"})};this.req_server_info=function(){this.set_state("SERVERINFO_REQ",!0);this.send_obj_now({obj:"server",act:"info",sdk:this.version()})};this.log_strings=[];this.log_total_len=0;this.log_add=function(a){this.log_strings.push(a);for(this.log_total_len+=a.length;10240<this.log_total_len;)a=
this.log_strings.shift(),this.log_total_len-=a.length};this.log_extra=function(){return""};this.sdk_logsend=function(a){this.send_obj_now({obj:"sdk",act:"logsend",to_pid:a,version:this.version(),data:this.log_strings.join("\n"),extra:this.log_extra()})};this.sdk_userdatasend=function(a){this.send_obj_now({obj:"sdk",act:"logsend",to_pid:a,data:this.user_data})};this.sdk_joreadsend=function(a,b){this.send_obj_now({obj:"sdk",act:"logsend",to_pid:a,data:b})};this.last_ping=0;this.websocket=null;this.from_state=
this.conn_state="LOGIN_SCREEN_SHOWN";this.target_state="SERVERINFO_REQ";this.minder=function(){if(("LOGIN_SCREEN_SHOWN"==this.conn_state||"LOGIN_SCREEN_ENABLED"==this.conn_state)&&(""!=this.login_name&&""!=this.login_passwd||null!=this.credential_data))this.connect();else if("IN_SESSION"==this.conn_state){var a=this.getUnixTime(),b=180;null!=this.server_info&&(null!=this.server_info.web_app_ping&&0<this.server_info.web_app_ping)&&(b=this.server_info.web_app_ping);this.last_resp<this.last_ping&&a-
this.last_ping>this.MAX_RESPONSE_TIME?(this.reset_websocket_conn(),setTimeout(e(this.connect,this),1E3*this.network_retry_timer_value())):a-this.last_ping>=b&&(this.clog("connection_minder ping initiated"),this.ping())}setTimeout(e(this.minder,this),1E3*this.MINDER_TIME)};setTimeout(e(this.minder,this),1E3*this.MINDER_TIME);this.clog("APIConnection init at unixtime: "+this.getUnixTime()+" version: "+this.version())};module.exports={APIConnection:APIConnection};